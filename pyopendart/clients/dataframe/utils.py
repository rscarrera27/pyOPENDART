...
DEFAULT_RENAME_MAPPING = {
    ...
    "qota_rt": "ratio",
    "change_cause": "reason",
    "shrholdr_co": "minority_shareholders_count",
    "shrholdr_tot_co": "total_shareholders_count",
    ...
    "fte_at": "is_full_time",
    "chrg_job": "work_in_charge",
    "main_career": "career_info",
    "mxmm_shrholdr_relate": "relation_to_major_shareholder",
    "hffc_pd": "tenure",
    "tenure_end_on": "tenure_end_date",
    "fo_bbm": "division",
    "reform_bfe_emp_co_rgllbr": "legacy_regular_employment_status",
    "reform_bfe_emp_co_cnttk": "legacy_contract_employment_status",
    "reform_bfe_emp_co_etc": "legacy_other_employment_status",
    "rgllbr_co": "regular_employment_status",
    "rgllbr_abacpt_labrr_co": "regular_employment_part_time_status",
    "cnttk_co": "contract_employment_status",
    "cnttk_abacpt_labrr_co": "contract_employment_part_time_status",
    "sm": "total",
    ...
    'fs_nm': "financial_statement_division_name",
    'sj_div': "financial_statement_type",
    'sj_nm': "financial_statement_type_name",
